...
semilogy(Eb_N0_dB, ber_qam_convolutional_two,...
    Eb_N0_dB, ber_qam_convolutional_one,...
    Eb_N0_dB, ber_qam_convolutional_gsm,...
    Eb_N0_dB, ber_qam_without_code,...
    Eb_N0_dB, ber_bpsk_convolutional_two,...
    Eb_N0_dB, ber_bpsk_convolutional_one,...
    Eb_N0_dB, ber_bpsk_convolutional_gsm,...
    Eb_N0_dB, ber_bpsk_without_code,...
    'LineWidth', 2, 'MarkerSize', 10);
xlabel('Eb/N0 (dB)');
ylabel('BER');
legend(strcat(qam_name, 'conv r=1/3'), ...
    strcat(qam_name, 'conv r=1/2'), ...
    strcat(qam_name, ' GSM'), ...
    strcat(qam_name, ' no cod'), ...
    'BPSK conv r=1/3', ...
    'BPSK conv r=1/2', ...
    'BPSK GSM', ...
    'BPSK no cod');
